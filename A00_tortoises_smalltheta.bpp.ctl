       ...
       seqfile = /gpfs/gibbs/pi/cgab/bpp/new_set1_1kb_w100kb_phased.txt
      Imapfile = /gpfs/gibbs/pi/cgab/bpp/tortoise_map_noLG_phased_Chaco.txt
       outfile = tortoise_phased_out1.txt
      mcmcfile = tortoise_phased_mcmc1.txt
...
* This run is for shallow divergence and small ancestral population. 
    ...
    thetaprior = 3 0.0001 e  # invgamma(a, b) for theta; mean=0.0025, var=0.0025
      tauprior = 3 0.001    # invgamma(a, b) for root tau & Dirichlet(a) for other tau's; mean=0.005, var=0.005

*     heredity = 1 4 4
*    locusrate = 1 5

      finetune = 1: 10.0 0.0001 0.0001 0.00001 0.1 .01 .01  # finetune for GBtj, GBspr, theta, tau, mix, locusrate, seqerr
